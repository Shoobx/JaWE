 ...
 *
 */
public class SetEndMode extends SetToolboxMode {

   public SetEndMode (GraphController jawecomponent) {
      super(jawecomponent,GraphEAConstants.END_TYPE, GraphEAConstants.END_TYPE_DEFAULT);
   }
