...
public class GraphSettings extends JaWEComponentSettings {
    ...
    public void loadDefault(JaWEComponent comp, Properties properties) {
        ...
        componentSettings.put("UseParticipantChoiceButton", new Boolean(properties.getProperty(
                "GraphPanel.UseParticipantChoiceButton", "true").equals("true")));
        componentSettings.put("UseActivitySetChoiceButton", new Boolean(properties.getProperty(
                "GraphPanel.UseActivitySetChoiceButton", "true").equals("true")));
        componentSettings.put("GraphOverview.Class", properties.getProperty("GraphOverview.Class",
                "org.enhydra.jawe.components.graph.overviewpanel.GraphOverviewPanel"));
        componentSettings.put("ShowGraphOverview", new Boolean(properties.getProperty("GraphOverview.Show",
                "true").equals("true")));
        componentSettings.put("NameWrapping", new Boolean(properties
                .getProperty("Graph.NameWrapping", "true").equals("true")));
        componentSettings.put("WordWrapping", new Boolean(properties.getProperty(
                "Graph.WrappingStyleWordStatus", "true").equals("true")));
        componentSettings.put("ShowGrid", new Boolean(properties.getProperty("Graph.ShowGrid", "false")
                .equals("true")));
        componentSettings.put("ShowIcons", new Boolean(properties.getProperty("Graph.ShowIcon", "true")
                .equals("true")));
        componentSettings.put("ShowShadow", new Boolean(properties.getProperty("Graph.ShowShadow", "true")
                .equals("true")));
        componentSettings.put("ShowTransitionCondition", new Boolean(properties.getProperty(
                "Graph.ShowTransitionCondition", "false").equals("true")));
        componentSettings.put("ShowTransitionNameForCondition", new Boolean(properties.getProperty(
                "Graph.ShowTransitionNameForCondition", "false").equals("true")));
        componentSettings.put("UseBubbles", new Boolean(properties.getProperty("Graph.UseBubbles", "true")
                .equals("true")));
        componentSettings.put("DrawBlockLines", new Boolean(properties.getProperty("Graph.DrawBlockLines",
                "true").equals("true")));
        componentSettings.put("DrawSubflowLines", new Boolean(properties.getProperty(
                "Graph.DrawSubflowLines", "true").equals("true")));

        componentSettings.put("GraphClass", properties.getProperty("Graph.Class",
                "org.enhydra.jawe.components.graph.Graph"));

        componentSettings.put("GraphControllerPanel", properties.getProperty("Graph.ControllerPanel",
                "org.enhydra.jawe.components.graph.GraphControllerPanel"));

        componentSettings.put("GraphManagerClass", properties.getProperty("GraphManager.Class",
                "org.enhydra.jawe.components.graph.GraphManager"));
        componentSettings.put("GraphMarqueeHandlerClass", properties.getProperty("GraphMarqueeHandler.Class",
                "org.enhydra.jawe.components.graph.GraphMarqueeHandler"));
        componentSettings.put("GraphModelClass", properties.getProperty("GraphModel.Class",
                "org.enhydra.jawe.components.graph.JaWEGraphModel"));
        componentSettings.put("GraphObjectFactoryClass", properties.getProperty("GraphObjectFactory.Class",
                "org.enhydra.jawe.components.graph.GraphObjectFactory"));
        componentSettings.put("GraphObjectRendererFactoryClass", properties.getProperty(
                "GraphObjectRendererFactoryClass",
                "org.enhydra.jawe.components.graph.GraphObjectRendererFactory"));
        componentSettings.put("DefaultTransitionStyle", properties.getProperty(
                "Graph.DefaultTransitionStyle", "NO_ROUTING_SPLINE"));
        ...
        componentSettings.put("ActivityWidth", new Integer(properties
                .getProperty("Graph.ActivityWidth", "85")));
        componentSettings.put("ParticipantNameWidth", new Integer(properties.getProperty(
                "Graph.ParticipantNameWidth", "50")));
        componentSettings.put("MinParWidth", new Integer(properties.getProperty("Graph.ParticipantMinWidth",
                "800")));
        componentSettings.put("MinParHeight", new Integer(properties.getProperty(
                "Graph.ParticipantMinHeight", "150")));
        componentSettings.put("AdditionalToolbar", new Boolean(properties.getProperty(
                "Graph.AdditionalToolbar", "false")));
        ...
        componentSettings.put("Graph.HistoryManager.Class", properties.getProperty(
                "Graph.HistoryManager.Class", "org.enhydra.jawe.HistoryMgr"));
        componentSettings.put("Graph.HistorySize", new Integer(properties.getProperty("Graph.HistorySize",
                "15")));
        ...
        componentSettings.put("BubbleColor", color);

        try {
            color = Utils.getColor(ResourceManager
                    .getResourceString(properties, "Graph.BubbleConectionColor"));
        } catch (Exception e) {
            color = Utils.getColor("SystemColor.textHighlight");
        }
        componentSettings.put("BubbleConectionColor", color);
        ...
        try {
            color = Utils.getColor(ResourceManager.getResourceString(properties, "Graph.StartActivityColor"));
        } catch (Exception e) {
        ...
        try {
            color = Utils.getColor(ResourceManager.getResourceString(properties, "Graph.EndActivityColor"));
        } catch (Exception e) {
        ...
        ImageIcon cicon;
        URL iconURL = ResourceManager.getResource(properties, "Graph.XPDLElement.Image.Defualt");
        if (iconURL != null)
            cicon = new ImageIcon(iconURL);
        else
            cicon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                    "org/enhydra/jawe/images/genericactivity.gif"));
        ...
        if (iconURL != null)
            ...
            cicon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                    "org/enhydra/jawe/images/start.gif"));
        componentSettings.put("BubbleStart", cicon);
        ...
        if (iconURL != null)
            ...
            cicon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                    "org/enhydra/jawe/images/end.gif"));
        componentSettings.put("BubbleEnd", cicon);

        iconURL = ResourceManager.getResource(properties, "Graph.XPDLElement.Image.FreeTextParticipant");
        if (iconURL != null)
            cicon = new ImageIcon(iconURL);
        else
            cicon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                    "org/enhydra/jawe/images/freetextparticipant.png"));
        ...
        if (iconURL != null)
            ...
            cicon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                    "org/enhydra/jawe/images/commonexpparticipant.png"));
        ...
        if (iconURL != null)
            ...
            cicon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                    "org/enhydra/jawe/images/participantsselect.gif"));
        ...
        if (iconURL != null)
            ...
            cicon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                    "org/enhydra/jawe/images/activitysetselect.gif"));
        ...
        if (iconURL != null)
            ...
            cicon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                    "org/enhydra/jawe/images/select.gif"));
    ...
    protected void loadDefaultMenusToolbarsAndActions(JaWEComponent comp) {
        ...
        componentSettings
                .put(
                        "graphEditToolbarToolbar",
                        "SaveAsJPG SaveAsSVG SaveAsPDF - ZoomIn ActualSize ZoomOut - MoveUpParticipant MoveDownParticipant - PreviousGraph NextGraph - InsertMissingStartAndEndBubbles RemoveStartAndEndBubbles - RotateProcess SimpleGraphLayout - InsertActivitySet");
        ...
        try {
            ...
            try {
                action = (ActionBase) Class.forName(clsName).getConstructor(
                        new Class[] { JaWEComponent.class }).newInstance(new Object[] { comp });
            } catch (Exception e) {
            }
            icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                    "org/enhydra/jawe/images/commonexpparticipantsetexp.png"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/actualsize.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/referred_document.png"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/addpoint.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/paste.gif"));
        langDepName = "Paste";
        ja = new JaWEAction(action, icon, langDepName);
        componentAction.put(action.getValue(Action.NAME), ja);
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/activitysetnew.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/participantdownright.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/participantupleft.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/nav_right_red.png"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/nav_left_red.png"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/startend.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/startend_remove.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/participantremove.png"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/removepoint.gif"));
        ...
        try {
            ...
            icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                    "org/enhydra/jawe/images/process_rotate.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/graph_layout.png"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/saveasjpg.gif"));
        ...
        try {
            ...
            action = (ActionBase) Class.forName(clsName).getConstructor(new Class[] { JaWEComponent.class })
                    .newInstance(new Object[] { comp });
            icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                    "org/enhydra/jawe/images/saveassvg.gif"));
        ...
        try {
            ...
            action = (ActionBase) Class.forName(clsName).getConstructor(new Class[] { JaWEComponent.class })
                    .newInstance(new Object[] { comp });
            icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                    "org/enhydra/jawe/images/saveaspdf.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/transitionbezier.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/transitionortogonal.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/transitionspline.gif"));
        ...
        action = new SetTransitionStyleNoRoutingBezier(comp);
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/transitionbeziersr.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/transitionortogonalsr.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/transitionsplinesr.gif"));
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/zoomin.gif"));
        langDepName = "ZoomIn";
        ja = new JaWEAction(action, icon, langDepName);
        componentAction.put(action.getValue(Action.NAME), ja);
        ...
        icon = new ImageIcon(ResourceManager.class.getClassLoader().getResource(
                "org/enhydra/jawe/images/zoomout.gif"));
        langDepName = "ZoomOut";
        ja = new JaWEAction(action, icon, langDepName);
        componentAction.put(action.getValue(Action.NAME), ja);
    }
    ...
    public ImageIcon getBubbleStartIcon() {
        return (ImageIcon) componentSettings.get("BubbleStart");
    }

    public ImageIcon getBubbleEndIcon() {
        return (ImageIcon) componentSettings.get("BubbleEnd");
    }
    ...
    public Color getBubbleColor() {
        return (Color) componentSettings.get("BubbleColor");
    }

    public Color getBubbleConectionColor() {
        return (Color) componentSettings.get("BubbleConectionColor");
    }
    ...
    public boolean performAutomaticLayoutOnInsertion() {
        return (JaWEManager.getInstance().getXPDLHandler().getXPDLRepositoryHandler() instanceof XPDLRepHandler);
    }
