...
import org.enhydra.jawe.components.packagenavigator.actions.CollapseAll;
import org.enhydra.jawe.components.packagenavigator.actions.ExpandAll;

/**
 * @author Miroslav Popov
 *
 */
public class PackageNavigatorSettings extends JaWEComponentSettings {

   public void init(JaWEComponent comp) {
      PROPERTYFILE_PATH = "org/enhydra/jawe/components/packagenavigator/properties/";
      PROPERTYFILE_NAME = "packagenavigator.properties";
      super.init(comp);
   }
