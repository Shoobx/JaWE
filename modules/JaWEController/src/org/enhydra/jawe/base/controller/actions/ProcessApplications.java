 ...
 */
public class ProcessApplications extends ActionBase {

   public ProcessApplications (JaWEComponent jawecomponent) {
      super(jawecomponent);
   }
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      jc.getSelectionManager().setSelection(getWorkflowProcess().getApplications(), false);            
      XPDLElementEditor ed=JaWEManager.getInstance().getXPDLElementEditor();
      ed.editXPDLElement(getWorkflowProcess().getApplications());
   }
}
