 ...
 */
public class PackageApplications extends ActionBase {

   public PackageApplications (JaWEComponent jawecomponent) {
      super(jawecomponent);
   }
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      jc.getSelectionManager().setSelection(getPackage().getApplications(), false);                  
      XPDLElementEditor ed=JaWEManager.getInstance().getXPDLElementEditor();
      ed.editXPDLElement(getPackage().getApplications());
   }
}
