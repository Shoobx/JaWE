 ...
 */
public class PackageTypeDeclarations extends ActionBase {

   public PackageTypeDeclarations (JaWEComponent jawecomponent) {
      super(jawecomponent);
   }
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      jc.getSelectionManager().setSelection(getPackage().getTypeDeclarations(), false);      
      XPDLElementEditor ed=JaWEManager.getInstance().getXPDLElementEditor();
      ed.editXPDLElement(getPackage().getTypeDeclarations());
   }
}
