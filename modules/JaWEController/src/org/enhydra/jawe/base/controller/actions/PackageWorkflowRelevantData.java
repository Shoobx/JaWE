 ...
 */
public class PackageWorkflowRelevantData extends ActionBase {

   public PackageWorkflowRelevantData (JaWEComponent jawecomponent) {
      super(jawecomponent);
   }
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      jc.getSelectionManager().setSelection(getPackage().getDataFields(), false);            
      XPDLElementEditor ed=JaWEManager.getInstance().getXPDLElementEditor();
      ed.editXPDLElement(getPackage().getDataFields());
   }
}
