 ...
 */
public class ProcessWorkflowRelevantData extends ActionBase {

   public ProcessWorkflowRelevantData (JaWEComponent jawecomponent) {
      super(jawecomponent);
   }
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      jc.getSelectionManager().setSelection(getWorkflowProcess().getDataFields(), false);      
      XPDLElementEditor ed=JaWEManager.getInstance().getXPDLElementEditor();
      ed.editXPDLElement(getWorkflowProcess().getDataFields());
   }
}
