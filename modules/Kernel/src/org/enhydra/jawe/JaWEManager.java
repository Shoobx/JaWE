...
public class JaWEManager {
    ...
    public static void configure(Properties props) {
        if (isConfigured) {
            JaWEManager.getInstance().getLoggingManager().info(
                    "Trying to configure " + jaweManager.getName()
    ...
    public static void configure(File configFile) {
        ...
        if (configFile.exists()) {
            ...
            try {
                ...
                throw new Error("Something went wrong while reading of configuration from the file!!!", ex);
            }
        } else {
            throw new Error(jaweManager.getName() + " needs to be configured properly - configuration file "
    ...
    protected static void configureFromJar() {
        try {
            ...
            URL u = JaWEManager.class.getClassLoader().getResource(
                    JaWEConstants.JAWE_BASIC_PROPERTYFILE_PATH + JaWEConstants.JAWE_BASIC_PROPERTYFILE_NAME);
            ...
            Utils.copyPropertyFile(JaWEConstants.JAWE_BASIC_PROPERTYFILE_PATH,
                    JaWEConstants.JAWE_BASIC_PROPERTYFILE_NAME, false);

            u = JaWEManager.class.getClassLoader().getResource(
                    JaWEConstants.JAWE_LANGUAGE_MISC_PROPERTYFILE_PATH
            ...
            Utils.copyPropertyFile(JaWEConstants.JAWE_LANGUAGE_MISC_PROPERTYFILE_PATH,
                    JaWEConstants.JAWE_LANGUAGE_MISC_PROPERTYFILE_NAME, false);

        } catch (Exception ex) {
            ex.printStackTrace();
            throw new Error(jaweManager.getName() + " need to be configured properly - Can't read "
                    + jaweManager.getName() + "'s default configuration from JAR!!!", ex);
        }
    }
    ...
    public void init() {
        ...
        String xpdlutClass = properties.getProperty("XPDLUtils.Class", "org.enhydra.jawe.XPDLUtils");
        ...
        try {
            ...
            loggingManager.info("JaWEManager -> Working with '" + lmClass
        ...
        try {
            ...
            loggingManager.info("JaWEManager -> Working with '" + xpdlutClass
                    + "' implementation of XPDLUtils");
        } catch (Throwable ex) {
            xpdlUtils = new XPDLUtils();
            String msg = "JaweManager -> Problems while instantiating XPDL Utils '" + xpdlutClass
        ...
        try {
            ...
            loggingManager.info("JaWEManager -> Working with '" + xpdlrhClass
        ...
        loggingManager.info("JaWEManager -> Working with '" + xpdlHandler.getClass().getName()
        ...
        try {
            ...
            Constructor c = Class.forName(jcClass).getConstructor(new Class[] { ControllerSettings.class });
            jaweController = (JaWEController) c.newInstance(new Object[] { cs });
            jaweController.init();
            loggingManager.info("JaWEManager -> Working with '" + jcClass
                    + "' implementation of JaWE Controller");
        } catch (Throwable ex) {
            jaweController = new JaWEController(new ControllerSettings());
            jaweController.init();
            String msg = "JaweManager -> Problems while instantiating JaWE Controller '" + jcClass
                    + "' - using default implementation!";
            loggingManager.error(msg, ex);
        }
        ...
        try {
            ...
            Constructor c = Class.forName(lgClass).getConstructor(
                    new Class[] { LabelGeneratorSettings.class });
            labelGenerator = (StandardLabelGenerator) c.newInstance(new Object[] { ls });
            loggingManager.info("JaWEManager -> Working with '" + lgClass
                    + "' implementation of Label Generator");
        } catch (Exception ex) {
            labelGenerator = new StandardLabelGenerator();
            String msg = "JaweManager -> Problems while instantiating Label Generator '" + lgClass
                    + "' - using default implementation!";
            loggingManager.error(msg, ex);
        }
        ...
        try {
            ...
            Constructor c = Class.forName(thClass).getConstructor(
                    new Class[] { TransitionHandlerSettings.class });
            transitionHandler = (TransitionHandler) c.newInstance(new Object[] { ts });
            loggingManager.info("JaWEManager -> Working with '" + thClass
                    + "' implementation of Transition Handler");
        } catch (Throwable ex) {
            transitionHandler = new TransitionHandler();
            String msg = "JaweManager -> Problems while instantiating Transition Handler class '" + thClass
                    + "' - using default implementation!";
            loggingManager.error(msg, ex);
        }
        ...
        try {
            ...
            Constructor c = Class.forName(idfClass).getConstructor(new Class[] { IdFactorySettings.class });
            idFactory = (IdFactory) c.newInstance(new Object[] { is });
            loggingManager
                    .info("JaWEManager -> Working with '" + idfClass + "' implementation of Id Factory");
        } catch (Throwable ex) {
            idFactory = new IdFactory();
            String msg = "JaweManager -> Problems while instantiating Id Factory class '" + idfClass
                    + "' - using default implementation!";
            loggingManager.error(msg, ex);
        }
        ...
        try {
            ...
            Constructor c = Class.forName(xpdlofClass).getConstructor(
                    new Class[] { XPDLObjectFactorySettings.class });
            xpdlObjectFactory = (XPDLObjectFactory) c.newInstance(new Object[] { os });
            loggingManager.info("JaWEManager -> Working with '" + xpdlofClass
                    + "' implementation of XPDL Object Factory");
        } catch (Throwable ex) {
        ...
        try {
            ...
            loggingManager.info("JaWEManager -> Working with '" + pnlvClass
                    + "' implementation of Panel Validator");
        } catch (Throwable ex) {
            panelValidator = new StandardPanelValidator();
            String msg = "JaweManager -> Problems while instantiating Panel Validator class '" + pnlvClass
                    + "' - using default implementation!";
            loggingManager.error(msg, ex);
        }
        ...
        try {
            ...
            Constructor c = Class.forName(xpdlvClass).getConstructor(new Class[] { Properties.class });
            xpdlValidator = (StandardPackageValidator) c.newInstance(new Object[] { xvs.getProperties() });
            loggingManager.info("JaWEManager -> Working with '" + xpdlvClass
                    + "' implementation of XPDL Validator");
        } catch (Throwable ex) {
            XPDLValidatorSettings vs = new XPDLValidatorSettings();
            vs.init(null);
            xpdlValidator = new StandardPackageValidator(vs.getProperties());
            String msg = "JaweManager -> Problems while instantiating XPDL Validator class '" + xpdlvClass
                    + "' - using default implementation!";
            loggingManager.error(msg, ex);
        }
        ...
        try {
            ...
            Constructor c = Class.forName(dngClass).getConstructor(
                    new Class[] { DisplayNameGeneratorSettings.class });
            displayNameGenerator = (StandardDisplayNameGenerator) c.newInstance(new Object[] { ds });
            loggingManager.info("JaWEManager -> Working with '" + dngClass
                    + "' implementation of Display Name Generator");
        } catch (Exception ex) {
        ...
        try {
            ...
            loggingManager.info("JaWEManager -> Using '" + panelGeneratorClassName
        ...
        try {
            ...
            loggingManager.info("JaWEManager -> Using '" + inlinePanelClassName
                    + "' implementation of Inline Panel");
        } catch (Exception ex) {
        ...
        try {
            ...
            Constructor c = Class.forName(xpdleeClass).getConstructor(new Class[] { PanelSettings.class });
            xpdlElementEditor = (XPDLElementEditor) c.newInstance(new Object[] { ps });
            loggingManager.info("JaWEManager -> Working with '" + xpdleeClass
                    + "' implementation of XPDL Element Editor ");
        } catch (Throwable ex) {
        ...
        try {
            ...
            Constructor c = Class.forName(teClass).getConstructor(new Class[] { TableEditorSettings.class });
            tableEditor = (TableEditor) c.newInstance(new Object[] { ts });
            loggingManager.info("JaWEManager -> Working with '" + teClass
                    + "' implementation of Table Editor ");
        } catch (Throwable ex) {
            tableEditor = new TableEditor(new TableEditorSettings());
            String msg = "JaweManager -> Problems while instantiating table editor class '" + teClass
                    + "' - using default implementation!";
            loggingManager.error(msg, ex);
        }
        ...
        try {
            ...
            Constructor c = Class.forName(ttgClass).getConstructor(
                    new Class[] { TooltipGeneratorSettings.class });
            tooltipGenerator = (StandardTooltipGenerator) c.newInstance(new Object[] { ts });
            loggingManager.info("JaWEManager -> Working with '" + ttgClass
                    + "' implementation of Tooltip Generator");
        } catch (Exception ex) {
            tooltipGenerator = new StandardTooltipGenerator();
            String msg = "JaweManager -> Problems while instantiating Tooltip Generator class '" + ttgClass
                    + "' - using default implementation!";
            loggingManager.error(msg, ex);
        }
        ...
        try {
            ...
            loggingManager.info("JaWEManager -> Working with '" + cmClass
                    + "' implementation of Component Manager");
        } catch (Throwable ex) {
            componentManager = new ComponentManager();
            componentManager.init();
            String msg = "JaWEManger -> Problems while instantiating Component Manager class '" + cmClass
                    + "' - using default implementation!";
            loggingManager.error(msg, ex);
        }

        getXPDLHandler().getXPDLRepositoryHandler().setXPDLPrefixEnabled(
                Boolean.valueOf(properties.getProperty("UseXPDLPrefix", "true")).booleanValue());
        // caching resources
    ...
    public XPDLHandler createXPDLHandler(XPDLRepositoryHandler xpdlRHandler) {
        ...
        try {
            ...
            Constructor c = Class.forName(xpdlhClass).getConstructor(
                    new Class[] { XPDLHandlerSettings.class });
            xpdlh = (XPDLHandler) c.newInstance(new Object[] { hs });
        } catch (Throwable ex) {
            String msg = "JaweManager -> Problems while instantiating XPDL Handler class '" + xpdlhClass
                    + "' - using default!";
    ...
    public void start(String fileName) throws Throwable {
        ...
        try {
            try {
                f = new javax.swing.plaf.FontUIResource(JaWEManager.getFontName(), Font.PLAIN, JaWEManager
                        .getFontSize());
            } catch (Exception ex) {
                ex.printStackTrace();
        ...
        if (loggingManager != null) {
            loggingManager.info("JaWEManager -> " + getName()
                    + " editor initialization is finished, it lasted " + (tEnd - tStart) + " ms");
    ...
    class JaWEPropertyMgr implements PropertyMgr {
        ...
        public void manageProperties(JaWEComponent comp, JaWEComponentSettings settings, String path,
                String name) {
            try {
                settings.loadDefault(comp, loadProperties(path, name));
            } catch (Exception e) {
                System.err.println("Something's wrong with " + name
                        + ", it has been overwritten by the default one!");
                try {
                    settings.clear();
