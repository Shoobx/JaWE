...
public class SimpleNavigatorSettings extends JaWEComponentSettings {   
   ...
   protected void loadDefaultMenusToolbarsAndActions(JaWEComponent comp) {
      ...
      // menu
      componentSettings.put("defaultMenu", "ExpandAll CollapseAll - jaweAction_Duplicate jaweAction_Cut jaweAction_Copy jaweAction_Paste jaweAction_Delete - jaweAction_EditProperties");
