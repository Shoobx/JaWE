...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.titlepage.fontstyle.title" keep-with-next="always">
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.titlepage.fontstyle.subtitle">
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.titlepage.fontstyle.corpauthor" space-before="0.5em">
		<xsl:apply-templates select="." mode="article.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">			
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.titlepage.fontstyle.authorgroup" space-before="0.5em">
		<xsl:apply-templates select="." mode="article.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">				
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.titlepage.fontstyle.author" space-before="0.5em">
		<xsl:apply-templates select="." mode="article.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">						
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.titlepage.fontstyle.copyright" space-before="0.5em">
		<xsl:apply-templates select="." mode="article.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">						
...
-->
  ...
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="bookinfo/author/affiliation/orgname"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="info/author/affiliation/orgname"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="bookinfo/author/affiliation/address/street"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="info/author/affiliation/address/street"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="bookinfo/author/affiliation/address/postcode"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="info/author/affiliation/address/postcode"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="bookinfo/author/affiliation/address/city"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="info/author/affiliation/address/city"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="bookinfo/author/affiliation/address/country"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="info/author/affiliation/address/country"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="bookinfo/author/affiliation/address/phone"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="info/author/affiliation/address/phone"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="bookinfo/author/affiliation/address/fax"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="info/author/affiliation/address/fax"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="bookinfo/author/affiliation/address/email"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="info/author/affiliation/address/email"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="bookinfo/author/affiliation/address/otheraddr/ulink"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="info/author/affiliation/address/otheraddr/ulink"/>
...
<xsl:template name="book.titlepage">
  <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <xsl:if test = "$enhydra.discard.emptypages != 'true'"> <!--ADDED-->
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.titlepage.fontstyle.title">
		<xsl:call-template name="division.title">
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.titlepage.fontstyle.corpauthor">
		<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">				
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.titlepage.fontstyle.authorgroup">
		<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">						
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.titlepage.fontstyle.author">
		<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">								
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style" font-size="14.4pt" color="#800000" font-weight="bold" font-family="{$title.font.family}"  space-before="0.5em">
<xsl:call-template name="book.verso.title">
</xsl:call-template>
</fo:block>
</xsl:template>

<xsl:template match="orgname" mode="book.titlepage.verso.auto.mode">
...
<xsl:template match="street" mode="book.titlepage.verso.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style"  space-before="0.5em">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="postcode" mode="book.titlepage.verso.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="city" mode="book.titlepage.verso.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="country" mode="book.titlepage.verso.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="phone" mode="book.titlepage.verso.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="fax" mode="book.titlepage.verso.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="email" mode="book.titlepage.verso.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="ulink" mode="book.titlepage.verso.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.chapter.fontstyle.title">
		<xsl:call-template name="component.title">
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.chapter.fontstyle.subtitle">
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.chapter.fontstyle.corpauthor">
		<xsl:apply-templates select="." mode="chapter.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">				
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.chapter.fontstyle.authorgroup">
		<xsl:apply-templates select="." mode="chapter.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">						
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.chapter.fontstyle.author">
		<xsl:apply-templates select="." mode="chapter.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">						
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.chapter.fontstyle.copyright" space-before="0.5em">
		<xsl:apply-templates select="." mode="chapter.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">						
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.section.fontstyle.title">
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.section.fontstyle.subtitle">
		<xsl:apply-templates select="." mode="section.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">		
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.section.fontstyle.corpauthor">
		<xsl:apply-templates select="." mode="section.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">		
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.section.fontstyle.authorgroup">
		<xsl:apply-templates select="." mode="section.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">				
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.section.fontstyle.author">
		<xsl:apply-templates select="." mode="section.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">						
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
    <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.section.fontstyle.copyright" space-before="0.5em">
		<xsl:apply-templates select="." mode="section.titlepage.recto.mode"/>
		</fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">						
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="sidebar.titlepage.recto.style" font-family="{$title.font.family}" font-weight="bold">
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="sidebar.titlepage.recto.style" font-family="{$title.font.family}">
<xsl:apply-templates select="." mode="sidebar.titlepage.recto.mode"/>
</fo:block>
</xsl:template>
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="qandaset.titlepage.recto.style" text-align="start" margin-left="0.5in" margin-right="0.5in" font-family="{$body.font.family}">
<xsl:apply-templates select="." mode="qandaset.titlepage.recto.mode"/>
</fo:block>
</xsl:template>
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="qandaset.titlepage.recto.style" space-before="0.5em" text-align="start" margin-left="0.5in" margin-right="0.5in" font-family="{$body.font.family}">
<xsl:apply-templates select="." mode="qandaset.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template name="table.of.contents.titlepage.recto">
  <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="table.of.contents.titlepage.recto.style" space-before.minimum="1em" space-before.optimum="1.5em" space-before.maximum="2em" space-after="0.5em" margin-left="{$title.margin.left}" start-indent="0pt" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
...
<xsl:if test = "$enhydra.fontstyle.enable = 'true'">
	  <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="enhydra.contenttable.fontstyle.title">
		<xsl:call-template name="gentext">
		<xsl:with-param name="key" select="'ListofTables'"/>
		</xsl:call-template></fo:block>
</xsl:if>
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">
		<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="list.of.tables.titlepage.recto.style" space-before.minimum="1em" space-before.optimum="1.5em" space-before.maximum="2em" space-after="0.5em" margin-left="{$title.margin.left}" start-indent="0pt" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
		<xsl:call-template name="gentext">
		<xsl:with-param name="key" select="'ListofTables'"/>
		</xsl:call-template></fo:block>
</xsl:if>
...
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">	
		<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="list.of.figures.titlepage.recto.style" space-before.minimum="1em" space-before.optimum="1.5em" space-before.maximum="2em" space-after="0.5em" margin-left="{$title.margin.left}" start-indent="0pt" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
	<xsl:call-template name="gentext">
	<xsl:with-param name="key" select="'ListofFigures'"/>
	</xsl:call-template></fo:block>
</xsl:if>
...
<xsl:if test = "$enhydra.fontstyle.enable != 'true'">
		<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="list.of.examples.titlepage.recto.style" space-before.minimum="1em" space-before.optimum="1.5em" space-before.maximum="2em" space-after="0.5em" margin-left="{$title.margin.left}" start-indent="0pt" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
		<xsl:call-template name="gentext">
		<xsl:with-param name="key" select="'ListofExamples'"/>
		</xsl:call-template></fo:block>
</xsl:if>		
...
<xsl:template name="list.of.equations.titlepage.recto">
  <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="list.of.equations.titlepage.recto.style" space-before.minimum="1em" space-before.optimum="1.5em" space-before.maximum="2em" space-after="0.5em" margin-left="{$title.margin.left}" start-indent="0pt" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
<xsl:call-template name="gentext">
...
<xsl:template name="list.of.procedures.titlepage.recto">
  <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="list.of.procedures.titlepage.recto.style" space-before.minimum="1em" space-before.optimum="1.5em" space-before.maximum="2em" space-after="0.5em" margin-left="{$title.margin.left}" start-indent="0pt" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
<xsl:call-template name="gentext">
...
<xsl:template name="list.of.unknowns.titlepage.recto">
  <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="list.of.unknowns.titlepage.recto.style" space-before.minimum="1em" space-before.optimum="1.5em" space-before.maximum="2em" space-after="0.5em" margin-left="{$title.margin.left}" start-indent="0pt" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
<xsl:call-template name="gentext">
