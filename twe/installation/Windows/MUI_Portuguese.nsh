...
# LANG_ENGLISH
   ...
   LangString NAME ${LANG_ENGLISH} "${PROJECT_FULL_NAME} ${VERSION}-${RELEASE}" 
   LangString MID_NAME ${LANG_ENGLISH} "${PROJECT_FULL_NAME}" 
   ...
   VIAddVersionKey /LANG=${LANG_ENGLISH} "Comments" "${PROJECT_FULL_NAME} is a graphical application for Process Definition Modelling. It is compatible with WfMC specification - XPDL (XML Process Definition Language) version 1.0 - 102502"
   ...
   LangString home_page_link ${LANG_ENGLISH} "Visit ${PROJECT_FULL_NAME} Homepage"
   ...
   LangString TEXT_IO_PAGESUBTITLE_B ${LANG_ENGLISH} "${PROJECT_FULL_NAME} ${VERSION}-${RELEASE} works only with Java 1.4.1 or more JVM. JAVA can be found on http://java.sun.com/j2se/1.4"
   LangString TEXT_IO_PAGETITLE_A ${LANG_ENGLISH} ": Set javahome dir"
   LangString TEXT_IO_TITLE_A ${LANG_ENGLISH} "${PROJECT_FULL_NAME} ${VERSION}-${RELEASE} Setup: Java home directory"
   ...
   LangString MUI_TEXT_INSTALLING_SUBTITLE ${LANG_ENGLISH}  "Please wait while ${PROJECT_FULL_NAME} ${VERSION}-${RELEASE} is being installed."
   LangString MUI_TEXT_FINISH_TITLE ${LANG_ENGLISH}  "Installation completed"
   LangString MUI_TEXT_FINISH_SUBTITLE ${LANG_ENGLISH}  "${PROJECT_FULL_NAME} ${VERSION}-${RELEASE} installation is completed successfully."
   LangString MUI_TEXT_ABORT_TITLE ${LANG_ENGLISH}  "Installation Aborted"
   LangString MUI_TEXT_ABORT_SUBTITLE ${LANG_ENGLISH}  "${PROJECT_FULL_NAME} ${VERSION}-${RELEASE} installation is aborted"
   LangString MUI_UNTEXT_UNINSTALLING_TITLE ${LANG_ENGLISH}  "Uninstalling"
   LangString MUI_UNTEXT_UNINSTALLING_SUBTITLE ${LANG_ENGLISH}  "Please wait while ${PROJECT_FULL_NAME} ${VERSION}-${RELEASE} is being uninstalled."
   LangString MUI_UNTEXT_FINISH_TITLE ${LANG_ENGLISH}  "Uninstallation completed"
   LangString MUI_UNTEXT_FINISH_SUBTITLE ${LANG_ENGLISH}  "${PROJECT_FULL_NAME} ${VERSION}-${RELEASE} uninstallation completed successfully."
   LangString MUI_UNTEXT_ABORT_TITLE ${LANG_ENGLISH}  "Uninstallation aborted"
   LangString MUI_UNTEXT_ABORT_SUBTITLE ${LANG_ENGLISH}  "${PROJECT_FULL_NAME} ${VERSION}-${RELEASE} uninstallation is aborted"

   LangString INSTALL_FAILED_DETAIL ${LANG_ENGLISH}  "${PROJECT_FULL_NAME} ${VERSION}-${RELEASE} installation failed (output: $0)"
   LangString INSTALL_FAILED_MESSAGE ${LANG_ENGLISH}  "${PROJECT_FULL_NAME} ${VERSION}-${RELEASE} installation failed"
   LangString INSTALL_SUCCED_DETAIL ${LANG_ENGLISH}  "${PROJECT_FULL_NAME} ${VERSION}-${RELEASE} installation succeded (output: $0)"

   LangString xpdlfile ${LANG_ENGLISH}  "XPDL ${PROJECT_FULL_NAME} file"
