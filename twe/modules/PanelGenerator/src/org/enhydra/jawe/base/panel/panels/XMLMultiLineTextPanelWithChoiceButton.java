...
* @author Sasa Bojanic
*/
public class XMLMultiLineTextPanelWithChoiceButton extends XMLBasicPanel {
   ...
   public XMLMultiLineTextPanelWithChoiceButton (
         PanelContainer pc,
         XMLElement myOwner,
         boolean isVertical,
         int type,
         ...
         boolean isEnabled,
         List choices) {
      this(pc,myOwner, myOwner.toName(), myOwner.isRequired(), isVertical, type, wrapLines,choices, isEnabled);
   }
