...
public class TogWEStandardXPDLEditorSettings extends PanelSettings {
   ...
   public void init(JaWEComponent comp) {
      ...
      super.init(comp);
      try {
         Utils.copyPropertyFile(PROPERTYFILE_PATH, Utils.APP_EXTENSION_INFO, false);
      } catch (Exception ex) {
      }
   }
   ...
   public void loadDefault(JaWEComponent comp, Properties properties) {
      ...
      componentSettings.put("XMLActualParametersPanel.useAdvanced",
                            new Boolean(properties.getProperty("XMLActualParametersPanel.useAdvanced", "true").equals("true")));
      componentSettings.put("XMLActualParametersPanel.preferredNumberOfLinesForExpression",
                            new Integer(properties.getProperty("XMLActualParametersPanel.preferredNumberOfLinesForExpression", "4")));
      componentSettings.put("PreferredNumberOfLinesForExpression", new Integer(properties.getProperty("PreferredNumberOfLinesForExpression", "8")));
      ...
      componentSettings.put("SimplePanelTextWidth", new Integer(properties.getProperty("XMLBasicPanel.SimplePanelTextWidth", "400")));
      componentSettings.put("SimplePanelTextHeight", new Integer(properties.getProperty("XMLBasicPanel.SimplePanelTextHeight", "20")));
      componentSettings.put("XMLDataTypesPanel.Dimension.WIDTH", new Integer(properties.getProperty("XMLDataTypesPanel.Dimension.WIDTH", "500")));
      ...
      componentSettings.put("ApplyActionSavesXPDL", new Boolean(properties.getProperty("ApplyActionSavesXPDL", "false")));
      ...
      for (int i = 0; i < hideEls.size(); i++) {
         componentSettings.put("HideSubElements." + (String) hideEls.get(i),
                               ResourceManager.getResourceString(properties, "HideSubElements." + (String) hideEls.get(i)));
      }
      ...
      componentSettings.put("ShowColumns.XMLTablePanel.FormalParameters", "Id Name Mode DataType IsArray InitialValue");
      ...
      for (int i = 0; i < showCols.size(); i++) {
         componentSettings.put("ShowColumns." + (String) showCols.get(i),
                               ResourceManager.getResourceString(properties, "ShowColumns." + (String) showCols.get(i)));
      }
