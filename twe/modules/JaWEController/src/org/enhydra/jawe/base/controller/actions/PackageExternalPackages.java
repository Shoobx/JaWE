 ...
 */
public class PackageExternalPackages extends ActionBase {

   public PackageExternalPackages (JaWEComponent jawecomponent) {
      super(jawecomponent);
   }
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      jc.getSelectionManager().setSelection(getPackage().getExternalPackages(), false);                  
      XPDLElementEditor ed=JaWEManager.getInstance().getXPDLElementEditor();
      ed.editXPDLElement(getPackage().getExternalPackages());
   }
}
