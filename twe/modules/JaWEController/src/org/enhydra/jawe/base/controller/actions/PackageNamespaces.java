...
* @author Sasa Bojanic
*/
public class PackageNamespaces extends ActionBase {

   public PackageNamespaces (JaWEComponent jawecomponent) {
      super(jawecomponent);
   }
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      jc.getSelectionManager().setSelection(getPackage().getNamespaces(), false);                  
      XPDLElementEditor ed=JaWEManager.getInstance().getXPDLElementEditor();
      ed.editXPDLElement(getPackage().getNamespaces());
   }
