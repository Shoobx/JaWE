...
//   protected ImageIcon appIcon, logoIcon;
   ...
   public void addMainComponent(String name, JComponent c) {
      ...
      String tip = controller.getSettings().getLanguageDependentString("DoubleClickToMaximize") + " " + lanName + ". " + 
                             controller.getSettings().getLanguageDependentString("RightClickToAdd");
      ...
      try {
         ...
         if (temp.length == 1) {
            ...
            // one split
               ...
               if (smallSplitData[1].equals("H")) splitType = JSplitPane.VERTICAL_SPLIT;
         ...
         // many splits
            ...
            if (smallSplit1Data.length != 1) {
               if (smallSplit1Data[1].equals("H")) splitType = JSplitPane.VERTICAL_SPLIT;
            ...
            if (smallSplit2Data.length != 1) {
               if (smallSplit2Data[1].equals("H")) splitType = JSplitPane.VERTICAL_SPLIT;
            ...
            splitType = JSplitPane.HORIZONTAL_SPLIT;
            if (bigSplitString.equals("H")) splitType = JSplitPane.VERTICAL_SPLIT;
