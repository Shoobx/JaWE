...
public final class SharkValidationErrorIds {
   ...
   public static final String ERROR_MANUAL_START_AND_FINISH_MODE_FOR_TOOL_ACTIVITY = "ERROR_MANUAL_START_AND_FINISH_MODE_FOR_TOOL_ACTIVITY";
   ...
   public static final String ERROR_TOOL_AGENT_INVALID_PARAMETER_TYPE_EXTERNAL_LOCATION_TYPE_BYTE_ARRAY_REQUIRED = "ERROR_TOOL_AGENT_INVALID_PARAMETER_TYPE_EXTERNAL_LOCATION_TYPE_BYTE_ARRAY_REQUIRED";
   ...
   public static final String ERROR_TOOL_AGENT_INVALID_PARAMETER_TYPE_BASIC_TYPE_STRING_ARRAY_REQUIRED = "ERROR_TOOL_AGENT_INVALID_PARAMETER_TYPE_BASIC_TYPE_STRING_ARRAY_REQUIRED";

   public static final String ERROR_TOOL_AGENT_INVALID_PARAMETER_TYPE_BASIC_TYPE_BOOLEAN_REQUIRED = "ERROR_TOOL_AGENT_INVALID_PARAMETER_TYPE_BASIC_TYPE_BOOLEAN_REQUIRED";

   public static final String ERROR_TOOL_AGENT_INVALID_PARAMETER_TYPE_BASIC_TYPE_INTEGER_REQUIRED = "ERROR_TOOL_AGENT_INVALID_PARAMETER_TYPE_BASIC_TYPE_INTEGER_REQUIRED";
   ...
   public static final String ERROR_TOOL_AGENT_EXECUTE_SQL_MISSING_REQUIRED_PARAMETERS = "ERROR_TOOL_AGENT_EXECUTE_SQL_MISSING_REQUIRED_PARAMETERS";

   public static final String ERROR_TOOL_AGENT_FOP_TRANSFORMER_PARAMETER_REQUIRED = "ERROR_TOOL_AGENT_FOP_TRANSFORMER_PARAMETER_REQUIRED";
   ...
   public static final String ERROR_TOOL_AGENT_TXW_MISSING_REQUIRED_PARAMETERS = "ERROR_TOOL_AGENT_TXW_MISSING_REQUIRED_PARAMETERS";
   ...
   public static final String ERROR_TOOL_AGENT_XPATH_EXPRESSIONS_AND_RESULT_VARIABLE_IDS_PARAMETERS_NOT_MATCHING = "ERROR_TOOL_AGENT_XPATH_EXPRESSIONS_AND_RESULT_VARIABLE_IDS_PARAMETERS_NOT_MATCHING";

   public static final String ERROR_TOOL_AGENT_XPIL_XPIL_PARAMETER_REQUIRED = "ERROR_TOOL_AGENT_XPIL_XPIL_PARAMETER_REQUIRED";

   public static final String ERROR_TOOL_AGENT_XSLT_OR_FOP_RESULT_PARAMETER_REQUIRED = "ERROR_TOOL_AGENT_XSLT_OR_FOP_RESULT_PARAMETER_REQUIRED";

   public static final String ERROR_TOOL_AGENT_XSLT_OR_FOP_TRANSFORMER_PARAMETER_REQUIRED = "ERROR_TOOL_AGENT_XSLT_OR_FOP_TRANSFORMER_PARAMETER_REQUIRED";

   public static final String ERROR_TOOL_AGENT_POWERSHELL_SCRIPT_PARAMETER_REQUIRED = "ERROR_TOOL_AGENT_POWERSHELL_SCRIPT_PARAMETER_REQUIRED";
   ...
   public static final String ERROR_VARIABLE_INITIAL_VALUE_XPDL_STRING_VARIABLE_REFERENCES_NOT_ALLOWED = "ERROR_VARIABLE_INITIAL_VALUE_XPDL_STRING_VARIABLE_REFERENCES_NOT_ALLOWED";
   ...
   public static final String ERROR_NON_EXISTING_I18N_VARIABLE_REFERENCE = "ERROR_NON_EXISTING_I18N_VARIABLE_REFERENCE";
   ...
   public static final String WARNING_NON_EXISTING_I18N_VARIABLE_REFERENCE = "WARNING_NON_EXISTING_I18N_VARIABLE_REFERENCE";
   ...
   public static final String ERROR_INVALID_VARIABLE_TYPE_SCHEMA_TYPE_REQUIRED = "ERROR_INVALID_VARIABLE_TYPE_SCHEMA_TYPE_REQUIRED";
}
