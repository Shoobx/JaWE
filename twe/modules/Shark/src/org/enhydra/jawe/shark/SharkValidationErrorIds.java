...
public final class SharkValidationErrorIds {
   ...
   public static final String ERROR_DYNAMICSCRIPT_VARIABLE_CROSS_REFERENCES_NOT_ALLOWED = "ERROR_DYNAMICSCRIPT_VARIABLE_CROSS_REFERENCES_NOT_ALLOWED";

   public static final String ERROR_DYNAMICSCRIPT_VARIABLE_IMPLICIT_CROSS_REFERENCES_NOT_ALLOWED = "ERROR_DYNAMICSCRIPT_VARIABLE_IMPLICIT_CROSS_REFERENCES_NOT_ALLOWED";
   ...
   public static final String ERROR_VARIABLE_INITIAL_VALUE_CROSS_REFERENCES_NOT_ALLOWED = "ERROR_VARIABLE_INITIAL_VALUE_CROSS_REFERENCES_NOT_ALLOWED";

   public static final String ERROR_VARIABLE_INITIAL_VALUE_IMPLICIT_CROSS_REFERENCES_NOT_ALLOWED = "ERROR_VARIABLE_INITIAL_VALUE_IMPLICIT_CROSS_REFERENCES_NOT_ALLOWED";
   ...
   public static final String ERROR_SHARK_STRING_VARIABLE_CROSS_REFERENCES_NOT_ALLOWED = "ERROR_SHARK_STRING_VARIABLE_CROSS_REFERENCES_NOT_ALLOWED";

   public static final String ERROR_SHARK_STRING_VARIABLE_IMPLICIT_CROSS_REFERENCES_NOT_ALLOWED = "ERROR_SHARK_STRING_VARIABLE_IMPLICIT_CROSS_REFERENCES_NOT_ALLOWED";
