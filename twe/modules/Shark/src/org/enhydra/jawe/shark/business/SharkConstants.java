...
public class SharkConstants {
   ...
   public static final String EA_MAIL_TOOL_AGENT_SIGNING = "MAIL_TOOL_AGENT_SIGNING";
   ...
   public static final String EA_NEWPROC_ERROR_HANDLER_NEW_PROCESS_PACKAGE_ID = "NEWPROC_ERROR_HANDLER_NEW_PROCESS_PACKAGE_ID";

   public static final String EA_NEWPROC_ERROR_HANDLER_NEW_PROCESS_WORKFLOWPROCESS_ID = "NEWPROC_ERROR_HANDLER_NEW_PROCESS_WORKFLOWPROCESS_ID";
