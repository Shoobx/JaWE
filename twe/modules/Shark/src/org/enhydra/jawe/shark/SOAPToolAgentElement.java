...
public class SOAPToolAgentElement extends ToolAgentElementBase {

   public SOAPToolAgentElement(Application app, String name) {
      super(app, name);
   }
   ...
   public XMLAttribute getURLAttribute() {
      return (XMLAttribute) get("URL");
   }
   ...
   protected void handleStructure() {
      ...
      if (ea != null) {
         getURLAttribute().setValue(ea.getVValue());
      }
   }
