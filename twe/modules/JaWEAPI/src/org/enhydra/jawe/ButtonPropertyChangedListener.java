...
/**
 * A Listener class used to change "enable" state of buttons.
 */
public class ButtonPropertyChangedListener implements PropertyChangeListener {

   /** The instance of the button object which state will be changed. */
   AbstractButton button;

   /**
    * Creates new object.
    * 
    * @param b A button object which state will be changed.
    */
