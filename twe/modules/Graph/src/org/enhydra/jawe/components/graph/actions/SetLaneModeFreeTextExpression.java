 ...
 * @author Sasa Bojanic
 */
public class SetLaneModeFreeTextExpression extends SetLaneMode {

   public SetLaneModeFreeTextExpression (GraphController jawecomponent) {
      super(jawecomponent,GraphEAConstants.LANE_TYPE_FREE_TEXT_EXPRESSION);
   }
...
//         }
   ...
   protected ImageIcon getIcon () {
      return ((GraphSettings)jawecomponent.getSettings()).getFreeTextLaneIcon();
   }
