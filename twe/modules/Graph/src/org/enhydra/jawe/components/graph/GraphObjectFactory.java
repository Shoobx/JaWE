...
public class GraphObjectFactory {
   ...
   protected Map initActivityProperties (Point partPoint,Point offset,Activity act,String type) {
      ...
      Rectangle bounds=new Rectangle(partPoint.x+offset.x,partPoint.y+offset.y, GraphUtilities.getGraphController().getGraphSettings().getActivityWidth(),  GraphUtilities.getGraphController().getGraphSettings().getActivityHeight());
