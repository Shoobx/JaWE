 ...
 * @author Sasa Bojanic
 */
public class SelectConnectingActivitiesForSelectedAssociations extends ActionBase {

   public SelectConnectingActivitiesForSelectedAssociations(JaWEComponent jawecomponent) {
      super(jawecomponent);
   }
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if (selCels != null && selCels.length > 0) {
         ...
         while (it.hasNext()) {
            ...
            if (gai.getPropertyObject() instanceof Activity) {
