...
public class SimpleNavigator implements JaWEComponent, Observer, TreeSelectionListener {
   ...
   /** The type of the navigator component. It is always TREE component type. */
   protected String type = JaWEComponent.TREE_COMPONENT;

   /** The panel for this navigator. */
   protected SimpleNavigatorPanel panel;

   /** Flag that determines if update of navigator is in progress. */
   protected boolean updateInProgress = false;

   /**
    * The settings for this navigator.
    */
   protected SimpleNavigatorSettings settings;

   /**
    * Creates new instance of Simple navigator.
    * 
   ...
   /**
    * @return The settings for this navigator object.
    */
   ...
   public void update(Observable o, Object arg) {
      ...
      JaWEManager.getInstance()
         .getLoggingManager()
         .info("SimpleNavigator -> update for event " + info + " started ...");
      ...
      JaWEManager.getInstance()
         .getLoggingManager()
         .info("SimpleNavigator -> update ended...");
      long end = System.currentTimeMillis();
      double diffs = (end - start) / 1000.0;
      JaWEManager.getInstance()
         .getLoggingManager()
         .debug("THE UPDATE OF NAVIG COMPONENT LASTED FOR " + diffs + " SECONDS!");
   }

   /**
    * Updates navigator according to the information about XPDL model changes.
    * 
    * @param info {@link XPDLElementChangeInfo} instance describing XPDL model changes.
    */
   ...
   /**
    * Initializes navigator by creating and configuring {@link SimpleNavigatorPanel}.
    */
   protected void init() {
   ...
   public void valueChanged(TreeSelectionEvent e) {
      ...
      JaWEManager.getInstance()
         .getLoggingManager()
         .info("SimpleNavigator -> selection changed ...");
      ...
      for (int i = 0; i < sel.length; i++) {
         if (e.isAddedPath(sel[i])) {
            ...
            if (node == null || node.getXPDLElement() == null)
               return;
      ...
      JaWEManager.getInstance()
         .getLoggingManager()
         .info("SimpleNavigator -> observers notified about selection changed!");// to
                                                                                 // " + node + ",
                                                                                 // xpdlElement=";
