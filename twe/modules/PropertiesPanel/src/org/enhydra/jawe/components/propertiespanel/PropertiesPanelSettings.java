...
public class PropertiesPanelSettings extends PanelSettings {
   ...
   public void loadDefault (JaWEComponent comp,Properties properties) {
      ...
      componentSettings.put("UseScrollBar", new Boolean(properties.getProperty("InlinePanel.UseScrollBar","true").equals("true")));
      ...
      componentSettings.put("DisplayTitle", new Boolean(properties.getProperty("InlinePanel.DisplayTitle","true").equals("true")));
   ...
   protected void loadDefaultMenusToolbarsAndActions(JaWEComponent comp) {
      // toolbar
      componentSettings.put("defaultToolbarToolbar", "PreviousPanel NextPanel - Revert Apply jaweAction_EditProperties - ParentElementPanel");
