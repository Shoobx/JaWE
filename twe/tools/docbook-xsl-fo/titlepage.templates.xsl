				...
				<fo:table-body>
					<fo:table-row xsl:use-attribute-sets="book.colophon.table.info.row">
						<fo:table-cell xsl:use-attribute-sets="book.colophon.table.info.cell">
							...
							<!-- Address, Street -->
							<fo:block>
							<xsl:for-each select="ancestor-or-self::book/colophon/address/city">
								<xsl:value-of select="." />
							</xsl:for-each>
							<xsl:for-each select="ancestor-or-self::book/colophon/address/street">
								<xsl:value-of select="." />
							</xsl:for-each>
							</fo:block>
							<xsl:for-each select="ancestor-or-self::book/colophon/otheraddr">
