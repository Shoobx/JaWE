...
<xsl:param name="body.font.family">Calibri,serif</xsl:param>
...
<xsl:param name="footer.column.widths">1 6 1.2</xsl:param> <!-- 1.75 7.25  1 -->

<xsl:param name="footer.image.height">16mm</xsl:param>
...
<xsl:param name="header.image.filename">images/templates/header.jpg</xsl:param>
...
<xsl:attribute-set name="page.header.label">
  <xsl:attribute name="font-family"><xsl:value-of select="$title.fontset"/></xsl:attribute>
  <xsl:attribute name="font-weight">normal</xsl:attribute>
  <xsl:attribute name="font-style">normal</xsl:attribute>
  <xsl:attribute name="font-size">28pt</xsl:attribute>
...
<xsl:attribute-set name="page.header.block.label">
  <xsl:attribute name="block-progression-dimension">auto</xsl:attribute>
...
<xsl:attribute-set name="page.header.image">
...
<xsl:param name="page.margin.inner.title">
  <xsl:choose>
    <xsl:when test="$double.sided != 0">0in</xsl:when>
    <xsl:otherwise>0in</xsl:otherwise>
  </xsl:choose>
</xsl:param>

<xsl:param name="page.margin.outer.title">
  <xsl:choose>
    <xsl:when test="$double.sided != 0">0in</xsl:when>
    <xsl:otherwise>0in</xsl:otherwise>
  </xsl:choose>
...
<xsl:param name="region.outer.extent">0</xsl:param>
...
<xsl:param name="symbol.font.family">Calibri,Symbol,ZapfDingbats</xsl:param>
...
<xsl:param name="title.font.family">Calibri,sans-serif</xsl:param>
